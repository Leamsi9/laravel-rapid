        ...
        @foreach($posts as $post)
            ...
            <article class="flex flex-col shadow my-4">
                ...
                <div class="bg-white flex flex-col justify-start p-6">
                    ...
                    <a href="/blog/{{ $post->slug }}" class="text-3xl font-bold hover:text-gray-700 pb-4">{{ $post->title }}</a>
                    <p href="#" class="text-sm pb-3">
                        By <a href="#" class="font-semibold hover:text-gray-800">{{ $author->name }}</a>, Published on {{ $post->publish_date }}
                    </p>
